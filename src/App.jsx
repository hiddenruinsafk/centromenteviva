...
function AdminSettings({ config, onSave }) {
  const [f, setF] = useState({ name:"", address:"", phone:"", email:"", adminPassword:"", ownerEmail:"", svcId:"", tplId:"", pubKey:"", services: DEFAULT_SERVICES, social: {}, ...config, services: (config?.services || DEFAULT_SERVICES) });
